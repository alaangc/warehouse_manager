...
T123 progress (2026-09-12): migration implemented as `008_document_output.ts` after the existing 007 printer migration. Static checks pass; PostgreSQL integration validation is pending because this environment has no working Docker runtime. Keep T123 unchecked until the database checks pass.
