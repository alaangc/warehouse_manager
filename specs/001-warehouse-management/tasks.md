...
T124 progress (2026-09-12): implemented source snapshot loaders, source-scoped document/attempt repositories, canonical reuse, and encrypted principal/role/filter-bound keyset cursors preserving PostgreSQL microseconds. The 20 focused unit tests pass. The 17 direct repository integration tests are present but could not start because Docker is unavailable; keep T124 unchecked pending PostgreSQL validation. HTTP integration remains T126–T127.
